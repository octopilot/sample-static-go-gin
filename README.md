# sample-static-go-gin

**One repo: static frontend + Go (Gin) API.**
...
op build-push
docker run -p 8081:8080 sample-static-go-gin-api
docker run -p 8080:8080 -e PORT=8080 sample-static-go-gin-frontend
```
